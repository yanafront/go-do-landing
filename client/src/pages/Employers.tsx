          ...
          >
            ...
            >
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">2 мин</div>
                <div className="text-white/80 text-lg">до размещения задания</div>
              </div>
              <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">1. Создай задание</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">2. Выбирай исполнителя</h3>
              <p className="text-gray-600 text-lg">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">3. Получай результат</h3>
              <p className="text-gray-600 text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Качественно</h3>
              <p className="text-gray-600">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Удобно</h3>
              <p className="text-gray-600">
