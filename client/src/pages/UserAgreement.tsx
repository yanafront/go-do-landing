      ...
      <div className="relative z-10 pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none prose-invert">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">3. Регистрация и учетная запись</h2>
              <p className="text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">4. Права и обязанности пользователей</h2>
              <p className="text-white/80 mb-4">
                <strong className="text-white">4.1. Пользователь имеет право:</strong>
              </p>
              ...
              <p className="text-white/80 mb-4">
                <strong className="text-white">4.2. Пользователь обязуется:</strong>
              </p>
              <ul className="list-disc pl-6 text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">5. Финансовые отношения</h2>
              <p className="text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">6. Ответственность</h2>
              <p className="text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">7. Изменения в соглашении</h2>
              <p className="text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">8. Контактная информация</h2>
              <p className="text-white/80 mb-4">
