      ...
      <div className="pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">2. Какие данные мы собираем</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">3. Цели обработки данных</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">4. Правовые основания обработки</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">5. Сроки хранения данных</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">6. Передача данных третьим лицам</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">7. Права субъектов персональных данных</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">8. Меры защиты данных</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">9. Cookies и аналогичные технологии</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">10. Изменения в политике</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1A1A2E] mb-4">11. Контактная информация</h2>
              <p className="text-[#1A1A2E]/80 mb-4">
